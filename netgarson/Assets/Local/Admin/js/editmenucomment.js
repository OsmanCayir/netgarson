...
$("#button-save").click(function () {
    ...
    $.ajax({
        ...
        url: "/Admin/UpdateMenuComment",
        //data: JSON.stringify({ menuComment: menuComment, menuIDList: menuIDList }),
        data: JSON.stringify({ menuComment: menuComment }),
        success: function (data) {
            if (data.result == 100) {
                ...
                toastr.error("Menu seçmeden kayıt yapılamaz.", "Hata Kodu: 200.");
            }
