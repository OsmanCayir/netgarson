...
(function ($) {
    if ($.fn.ajaxForm == undefined) {
        ...
        $.getScript("/Assets/UploadFile/jquery.form.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        (function checkAjaxFormLoaded() {
            if ($.fn.ajaxForm) {
                ...
                if (s.showQueueDiv)
                    ...
                    obj.container = $("<div class='ajax-file-upload-container'></div>").insertAfter("#extrabutton");
        ...
        function defaultProgressBar(obj, s) {
            ...
            this.cancel.addClass("btn btn-warning btn-sm");
